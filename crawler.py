...
class Crawler(threading.Thread):
    ...
    #initializing the number of pages to be crawled, if the data should be saved, the starting url, the links to crawl, a list that keeps track of
    ...
    def run(self):
        ...
        while True:
            ...
            try:
                #This method constructs a full URL by combining the base url with other url. This uses components of the base URL, the network
